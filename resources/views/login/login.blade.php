@extends('layouts.principal-template')
    ...
    <div class="login-wrapper ">
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          ...
          <!-- START Login Form -->
          <form id="form-login" class="p-t-15" role="form" action="/dashboard">
            <!-- START Form Control-->
            <div class="form-group form-group-default">
              <label>Document Number</label>
              <div class="controls">
                <input type="text" name="username" placeholder="Put your identification document number" class="form-control" required>
              </div>
            </div>
            <!-- END Form Control-->
            <!-- START Form Control-->
            <div class="form-group form-group-default">
              ...
              <div class="controls">
                <input type="password" class="form-control" name="password" placeholder="Don't share your password" required>
              </div>
            </div>
            <!-- START Form Control-->
            <div class="row">
